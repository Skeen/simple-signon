...
CREATE TABLE `service` (
  ...
  `service_logo` varchar(128) DEFAULT NULL,
...
CREATE TABLE `user_service` (
  ...
  `auto_connect` bit(1) NOT NULL DEFAULT b'0',
...
CREATE TABLE `key_value` (
  ...
  `key_entry` varchar(32) NOT NULL,
  `value_entry` varchar(256) NOT NULL,
  PRIMARY KEY (`service_indirection_id`,`key_entry`),
