...
%undervejs.  TODO: Diskussion af vores valgte strategi TODO: Vælg et element af
%diskussion ud, og gå i dybten med denne.  Perspektiver elementet forhold til
%kursusliteratur.  (sæt det i forhold til artiklerne fra første 7 uger)
...
også gennemløbe op til flere yderligere iterationer.\citep[]{Stolterman2008} \\
...
Y.-K. Lim et al artiklen \citep[s.3,10]{Benyon2010Designing}.
...
\citep[s.7,17,18]{Benyon2010Designing}. En prototype der ikke virker som et
...
\citep[s.4]{Benyon2010Designing}.  Dette var også tilfældet for vores
...
også nævnes i Y.-K. Lim et al. artiklen, så er brugere ikke eksperter i design,
     \citep[s.5]{Benyon2010Designing} hvilket resulterer i, at man som designer
