...
taler så dermed også for et administrationsstyret system, i og med at hvis al funktionaliteten ligger ved administratorerne, og brugeren har mindst mulig
...
På den anden side kan der argumenteres for, at man med et brugerstyret system,
   som navnet også lægger op til, giver brugeren mulighed for at tilpasse
   systemet til lige netop ham eller hende.  I vores tilfælde, er der forskel
...
Gennem vores interviews med både lærere og IT-afdelingens Teamleder Lars Lisberg,
       fandt vi dog ud af, at der fra lærernes og IT-afdelingens side var et
       udbredt ønske om et brugerstyret system med mulighed for at tilpasse systemet
...
%\textbf{\large Problemer undervejs og de valgte løsninger:}\\
        ...
        Server, ifht. lokalt på ens egen maskine.  På den ene side, hvis data
        ...
        I øjeblikket ligger brugerens informationer ukrypteret på MySQL serveren, der er fordele og ulemper ved dette.       
        På den ene
        ...
        serveren.  Imidlertid vurderes sikkerheden af plain-tekst data felter på
        MySQL serveren som udmærket, jf. overstående, hvorfor vi også har
...
obfuskering er nok. F.eks. ved brug af ROT13 (Caesar cipher)
       ...
       \textit{ Note; Implementeringen af dette er skrevet i backloggen, som
        ...
        af sikkerhedsmæssige karakter, i særdeleshed, at https strømmen kan læses
        ...
        certifikat før kørsel af programmet. Alternativt, kunne man
        ...
        medføre.  Vi har primært haft to bud på, hvordan denne fleksibilitet
        ...
        forskel imellem disse er at førstnævnte kræver en fuldkommen opdatering
...
Først kan det diskuteres, om vi i projektet har gennemløbet iterationer
...
vi burde havde gennemløbet nogle flere iterationer, for derigennem at have
fået mere nyttigt feedback og informationer, som kunne have resulteret i et
...
indenfor.  Ideen med projektet har heller ikke været, at vi ved slutningen af
...
Hvis man kigger på den del af vores processtrategi, der er prototyping, kan det
diskuteres, om vi har benyttet vores prototyper hensigtsmæssigt.  Vores
...
vi har kreeret fornuftige prototyper, der i en præsentation for
brugerne ville sætte fokus på de specifikke dele af designet, som vi ønskede at
indsamle viden om, og om vores fokus har været for bredt med henhold
...
Y.-K. Lim et al artiklen \footnote{\citep[s.3,10]{Stolterman2008}}.
...
stå med en alt for stor kode-mæssig arbejdsbyrde.  Dog kan der argumenteres for,
...
\footnote{\citep[s.7,17,18]{Stolterman2008}}. En prototype, der ikke virker som et
færdigt produkt, lægger mere op til, at brugeren kan komme med forslag til
...
i en case, som de analyserede, hvor de fremviste to prototyper af et hus, en på
...
færdigt produkt, og derfor kom med langt færre forslag til ændringer.  Denne effekt,
...
prototyper, kan man argumentere for, at det ideelle havde været at lave en
...
\footnote{\citep[s.4]{Stolterman2008}}.  Dette var også tilfældet for vores
prototyper.  Vi valgte i stedet at foretage laboratorietests, hvor brugerne i
et kontrolleret miljø bliver præsenteret for prototyperne.  Vi valgte i vores
...
feedback med for lidt omtanke, når det gjaldt implementering af forslag.  Som det
også nævnes i Y.-K. Lim et al. artiklen, så er brugere ikke eksperter i design,
     ...
     frem for direkte at tilføje deres design ideer til produktet.  Selv om der
     kan argumenteres for, at vi nogle steder har tilføjet brugernes design ideer
     uden at vurdere, hvorvidt det virkelig bragte brugerne værdi, er der dog
     også eksempler på, at vi netop har gjort os disse overvejelser på nogle
     punkter.  Et ønske fra brugerne var fx, at systemet skulle laves som en Web
     applikation.  Dette endte vi dog ikke op med, da det stred mod et større
     ønske om, at systemet også automatisk skulle logge på VPN. Da det ikke er
