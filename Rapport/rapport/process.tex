...
Den bestod af et loginvindue(som ses på \autoref{sørenslortebillede2})
...
Nedenfor ses de dele af billedet der viser vores to primære ideer.
...
I stedt gik vi, som det ses i \autoref{figsdesign2}
...
Som det kan ses på \autoref{sørenslortebillede1}
