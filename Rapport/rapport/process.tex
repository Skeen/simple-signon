...
logo, med et lille piktogram som skulle vise servicens tilstand. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TODO: Link
...
autokonfigurationsscript ser ud, og vi har udviklet et sådanne der blot kan loades ind i brugernes browser, hvorefter proxy'en automatisk vil
blive konfigureret.
...
'Event system', frem for at alle klasses direkte kontaktede dem der skulle
...
hvilket har resulteret i en langt mere fleksibel og dynamisk kodebase, hvor alle
...
simpelthen blot laver en event, til at fortælle dette, til dem (om end nogle),
