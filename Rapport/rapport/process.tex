...
de har aktive, havde vi designet et 'tilføj' vindue, som nu var færdigt. 
Ved at tilføje og fjerne services, kan brugeren selv bestemme hvilke services bliver brugt. 
Dette ses på \autoref{adding}
Desuden blev rediger vinduet også færdigt, hvor brugeren kan indstille brugernavn og kodeord, samt hvorvidt en service forbinder automatisk.
Denne ses på \autoref{editing}.
